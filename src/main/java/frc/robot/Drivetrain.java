...
public class Drivetrain {
    ...
    private final double m_distancePerPulse = ( 2 * Math.PI * kWheelRadius / kEcoderResolution);
    ...
    public void updateOdometry(){
        ...
        m_odometry.update(m_gyro.getRotation2d(), m_leftLeader.getSelectedSensorPosition()*m_distancePerPulse, m_rightLeader.getSelectedSensorPosition()*m_distancePerPulse);
    }
    ...
    public void simulationPeriodic() {
        ...
        m_leftLeader.getSimCollection().setQuadratureRawPosition((int) (m_driveSim.getLeftPositionMeters()/m_distancePerPulse));
        m_leftLeader.getSimCollection().setQuadratureVelocity((int) (m_driveSim.getLeftVelocityMetersPerSecond()/m_distancePerPulse)*10);
        m_rightLeader.getSimCollection().setQuadratureRawPosition((int) (m_driveSim.getRightPositionMeters()/m_distancePerPulse));
        m_rightLeader.getSimCollection().setQuadratureVelocity((int) (m_driveSim.getRightPositionMeters()/m_distancePerPulse)*10);
